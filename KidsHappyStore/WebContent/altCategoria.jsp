	      ...
	      <div class="row-fluid">
	        ...
	        <div class="span9">
	         <div class="container-fluid">	
	          ...
	          <jsp:useBean id="categoria" scope="session" class="br.com.kidshppystore.bean.Categoria" />
	          	...
	          	<form action="ServletCategoria?cmd=atualizar" method="post">
					 <tbody>
						 ...
						 <tr>
						   ...
						   <tr>
							<th><h4>Linha</h4></th>
							<td><input type="text" name="linha" size="10" maxlenght="10"  value="<%=categoria.getLinha()%>"/></td>
						 </tr>
						  <tr>
							<th><h4>Faixa Etária</h4></th>
							<td><input type="text" name="faixa_etaria" size="10" maxlenght="10"  value="<%=categoria.getFaixa_etaria()%>"/></td>
						 </tr>
