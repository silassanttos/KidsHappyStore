	          		...
	          		<center>
						...
						<thead class="thead-dark">
							<tr style="border-botton: none;">
								<th colspan="6" style="text-align: center;"><h3>Lista de Categorias</h3></th>
							</tr>
							</thead>
							<tr>
								<th colspan="6" style="text-align: right;">
									<a href="cadCategoria.jsp"><img src="icon/novo_.png" style="width: 20px;">Adicionar Nova</a>
								</th>
							</tr>
							...
							<tr>
								...
								<td><%=c.getLinha()%></td>
								<td><%=c.getFaixa_etaria()%></td>
								<td style="text-align: center;"><a href="ServletCategoria?cmd=atu&id=<%=c.getIdCategoria()%>"><img src="icon/edit.png" style="width: 20px; position: center;"></a></td>
								<td style="text-align: center;"><a href="ServletCategoria?cmd=exc&id=<%=c.getIdCategoria()%>"><img src="icon/excluir_.png" style="width: 20px;"></a></td>
							</tr>
							<% 
								}
							%>				
